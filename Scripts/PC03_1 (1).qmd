...
En este ejemplo, el predictor categórico tenía solo dos niveles (Si y No), por lo que se obtiene el valor p que prueba su asociación con el Estadio T a partir de la tabla de coeficientes de la regresión (0.793)
...
```{r}
reg_poisson2 = glm( Volumen_prostata, data = almac_sangre1, family = "poisson")
summary(reg_poisson2)
```
