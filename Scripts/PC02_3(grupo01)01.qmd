...
```{r}
almac_sangre |>  
  ggplot(aes(x = Volumen_tumoral)) +
  geom_histogram(
    color = "pink",
    ) + 
  labs(y = "Frecuencia", 
       x = "Volumen Tumoral") +
  geom_vline(xintercept = mean(almac_sangre$Volumen_tumoral, na.rm = TRUE),
...
deacuerdo al valor P que es mas a 0.5 podemos decir de que hay una relación entre el volúmen de prostata y el PSA preoperatorio
...
El valor p de la prueba F es p =0.2584 Es mayor que el nivel de significancia α = 0.05. En conclusión, no hay una diferencia significativa entre las varianzas de los dos conjuntos (son raza afromericana,no son raza afroamercana) de datos. Por lo tanto, podemos usar la prueba t clásica que asume igualdad de varianzas.
